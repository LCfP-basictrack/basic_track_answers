...
f1_data_frame = pd.DataFrame(f1_dictionary, columns=["year", "champ", "wins", "points", "gender"])


# f1_data_frame.to_csv("f1_fifties.csv")
# f1_df_from_file = pd.read_csv("f1_fifties.csv")
